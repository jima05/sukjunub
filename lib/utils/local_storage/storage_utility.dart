...
class SukjunubLocalStorage {
  static final SukjunubLocalStorage _instance = SukjunubLocalStorage._internal();

  factory SukjunubLocalStorage() {
    return _instance;
  }

  SukjunubLocalStorage._internal();
