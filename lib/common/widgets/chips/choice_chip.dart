...
class SukjunubChoiceChip extends StatelessWidget {
  const SukjunubChoiceChip({
    super.key,
    required this.text,
  ...
  Widget build(BuildContext context) {
    final isColor = SukjunubHelperFunctions.getColor(text);
    return Theme(
      ...
      child: ChoiceChip(
        ...
        backgroundColor: isColor != null ? Colors.green : null,
      ),
    );
  }
}
