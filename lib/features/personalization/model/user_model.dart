...
import 'package:sukjunub/utils/formatters/formatter.dart';

class UserModel {
  // keep values you do not want to update as final
  final String id;
  String firstName;
  String lastName;
  ...
  String get formattedPhoneNo =>
      SukjunubFormatter.formatPhoneNumber(phoneNumber);
  ...
  // Static function to create to create an empty user model
